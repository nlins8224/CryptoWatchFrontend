...
export const columns: any = [
    {
        ...
        sorter: (a: { symbol: string }, b: { symbol: any }) =>
    ...
    },
    {
        ...
        key: 'price_change',
        sorter: (a: { price_change: number }, b: { price_change: number }) =>
            a.price_change - b.price_change,
    },
    {
        title: '% Price Change',
        ...
        sorter: (
            a: { price_change_percentage: number },
            b: { price_change_percentage: number },
        ) => a.price_change_percentage - b.price_change_percentage,
    },
    {
        title: 'High',
        dataIndex: 'high',
